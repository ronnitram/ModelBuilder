...
static GS::UniString	FindObjectSetName (const API_Guid& objectId)
{
	if (objectSetsToReport.IsEmpty ()) {
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("Composites"),					"Composites");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("FillTypes"),					"Fill Types");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("LayerSettingsDialog"),		"Layer Settings");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("LineTypes"),					"Line Types");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("Surfaces"),					"Surfaces");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("MEPSystems"),					"MEP Systems");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("OperationProfiles"),			"Operation Profiles");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("PenTables"),					"Pen Tables");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("Profiles"),					"Profiles");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("ZoneCategories"),				"Zone Categories");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("BuildingMaterials"),			"Building Materials");
		objectSetsToReport.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("IssueTags"),					"Issue Tags");
	}
...
static GSErrCode __ACENV_CALL	LockChangeHandler (const API_Guid& objectId, short ownerId)
{
	...
	lockableObjectSets.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("Favorites"),			"Favorites");
	lockableObjectSets.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("ModelViewOptions"),	"Model View Options");
	lockableObjectSets.Add (ACAPI_TeamworkControl_FindLockableObjectSet ("ProjectInfo"),		"Project Info");
...
void	Do_ReservationMonitor (bool switchOn)
{
	if (switchOn) {
		...
		ACAPI_Notify_CatchLockableReservationChange (LockChangeHandler);
	} else {
