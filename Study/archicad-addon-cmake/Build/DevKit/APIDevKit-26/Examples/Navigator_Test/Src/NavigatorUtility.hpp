...
public:
	...
	static GSErrCode	__ACENV_CALL	APINavigatorAddOnViewPointDataMergeHandler (const GS::Array<API_NavigatorAddOnViewPointData>&	sourceVPDataArray);
	static GSErrCode	__ACENV_CALL	APINavigatorAddOnViewPointDataSaveOldFormatHandler (API_FTypeID												/*planFileType*/,
	...
	static GSErrCode	__ACENV_CALL	APINavigatorAddOnViewPointDataConvertNewFormatHandler (API_FTypeID											/*planFileType*/,
