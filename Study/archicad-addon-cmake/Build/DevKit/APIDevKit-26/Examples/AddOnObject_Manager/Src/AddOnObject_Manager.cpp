...
GSErrCode	__ACENV_CALL	RegisterInterface (void)
{
	...
	ACAPI_Register_Menu (ClientOnlyObjectMenuStringResourceId, 0, MenuCode_UserDef, MenuFlag_Default);
...
GSErrCode __ACENV_CALL	Initialize (void)
{
	...
	err |= ACAPI_Install_MenuHandler (ClientOnlyObjectMenuStringResourceId, MenuCommandHandler);
	if (err == NoError)
