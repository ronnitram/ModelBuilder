...
{
	GSErrCode err = ACAPI_Register_Menu (COMMUNICATION_CLIENT_TEST_MENU_STRINGS, 0, MenuCode_UserDef, MenuFlag_SeparatorBefore | MenuFlag_SeparatorAfter);
...
{
	GSErrCode err = ACAPI_Install_MenuHandler (COMMUNICATION_CLIENT_TEST_MENU_STRINGS, MenuCommandHandler);
