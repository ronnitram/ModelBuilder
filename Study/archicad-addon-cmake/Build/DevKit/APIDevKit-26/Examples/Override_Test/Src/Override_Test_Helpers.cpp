...
{
	return a.attributeIndex == b.attributeIndex && a.overridden == b.overridden;
}
...
{
	if (a.attributeStyle.Is<API_AttributeIndex> () && b.attributeStyle.Is<API_AttributeIndex> ()) {
		return a.attributeStyle.Get<API_AttributeIndex> () == b.attributeStyle.Get<API_AttributeIndex> () && a.overridden == b.overridden;
	} else {
		return IsNear (a.attributeStyle.Get<API_RGBColor> (), b.attributeStyle.Get<API_RGBColor> ()) && a.overridden == b.overridden;
	}
}
