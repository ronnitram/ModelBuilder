...
static GSErrCode __ACENV_CALL ProjectEventHandler (API_NotifyEventID notifID, Int32 /*param*/)
{
	switch (notifID) {
	case APINotify_New:
...
static bool __ACENV_CALL ClassificationVisibilityHandler (API_ClassificationVisibilityMode visibilityMode, const GS::Array<API_Guid>& classificationGuids, const API_Guid& classificationItemGuid)
{
...
static bool __ACENV_CALL PropertyVisibilityHandler (API_PropertyVisibilityMode visibilityMode, const GS::Array<API_Guid>& classificationGuids, const API_Guid& propertyDefinitionGuid)
{
...
GSErrCode	__ACENV_CALL	RegisterInterface (void)
{
	...
	err = ACAPI_Register_ClassificationVisibilityHandler ();
...
GSErrCode	__ACENV_CALL Initialize	(void)
{
	...
	err = ACAPI_Notify_CatchProjectEvent (	APINotify_New |
	...
	err = ACAPI_Install_ClassificationVisibilityHandler (ClassificationVisibilityHandler);
	if (err != NoError) {
		return err;
	}
