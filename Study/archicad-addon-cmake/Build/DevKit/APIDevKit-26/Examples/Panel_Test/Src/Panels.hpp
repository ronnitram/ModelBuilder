...
private:
	...
	enum {
		...
		FireResistanceRatingPopupId	= 10,
		DefaultValueCheckBoxId		= 11
	};
	...
	DG::PopUp			fireResistanceRatingPopup;
	DG::CheckBox		defaultValueCheckBox;
...
private:
	...
	API_Property	GetFireResistanceRatingProperty (void);
	void			SetFireResistanceRatingProperty (const API_Property& property);
