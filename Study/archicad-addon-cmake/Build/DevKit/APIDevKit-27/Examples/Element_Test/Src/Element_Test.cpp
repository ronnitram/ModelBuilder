	...
	return ACAPI_CallUndoableCommand ("Element Test API Function",
		[&] () -> GSErrCode {
			...
			switch (menuParams->menuItemRef.itemIndex) {
				...
				case 43:	Do_ChangeMarker_Edit ();			break;
				case 44:	Do_Arc_Edit ();						break;
				/* ----- */
				case 46:	Do_RotateRenovationStatus ();		break;
				case 47:	Do_TestMaterialChaining ();			break;
				/* ----- */
				case 49:	Do_ModifyProfileParameter ("Cover Thickness Left", 0.045); break;
				case 50:	Do_Modify_Opening ();				break;
				/* ----- */
				case 52:	Do_CopyAddPars_FromFirstClickedElementIntoSecondClickedElement ();		break;
				default:
							break;
			}
