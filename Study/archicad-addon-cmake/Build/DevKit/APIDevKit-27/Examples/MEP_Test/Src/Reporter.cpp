...
GS::UniString ToString (ACAPI::MEP::PreferenceTableShape shape)
{
	switch (shape) {
		case ACAPI::MEP::PreferenceTableShape::Rectangular:
			return u"Rectangular"sv;
		case ACAPI::MEP::PreferenceTableShape::Circular:
			return u"Circular"sv;
	}
