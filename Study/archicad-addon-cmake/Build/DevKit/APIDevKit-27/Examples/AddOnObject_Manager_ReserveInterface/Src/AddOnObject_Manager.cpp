...
GSErrCode	__ACENV_CALL	RegisterInterface (void)
{
	...
	ACAPI_MenuItem_RegisterMenu (ClientOnlyObjectMenuStringResourceId, 0, MenuCode_UserDef, MenuFlag_Default);
...
GSErrCode __ACENV_CALL	Initialize (void)
{
	...
	err |= ACAPI_MenuItem_InstallMenuHandler (ClientOnlyObjectMenuStringResourceId, MenuCommandHandler);
	if (err == NoError)
