								 ...
								 Int32 					dim2)
{
	...
	switch (typeID) {
		case APIParT_FillPat:	head.Append (" \"");
								DumpUtils::GetAttrName (nullptr, API_FilltypeID, ACAPI_CreateAttributeIndex ((short)value), &name);
								head.Append (name);
								head.Append ("\"");
		...
		case APIParT_Mater:		head.Append (" \"");
								DumpUtils::GetAttrName (nullptr, API_MaterialID, ACAPI_CreateAttributeIndex ((short)value), &name);
								head.Append (name);
								head.Append ("\"");
								WriteStr (head, WithNewLine);
								break;
		...
		case APIParT_BuildingMaterial:
								head.Append (" \"");
								DumpUtils::GetAttrName (nullptr, API_BuildingMaterialID,ACAPI_CreateAttributeIndex ((short)value), &name);
								head.Append (name);
								head.Append ("\"");
								WriteStr (head, WithNewLine);
								break;
		...
		case APIParT_Profile:	head.Append (" \"");
								DumpUtils::GetAttrName (nullptr, API_ProfileID, ACAPI_CreateAttributeIndex ((short)value), &name);
								head.Append (name);
								head.Append ("\"");
								WriteStr (head, WithNewLine);
								break;
		...
		case APIParT_LineTyp:	head.Append (" \"");
								DumpUtils::GetAttrName (nullptr, API_LinetypeID, ACAPI_CreateAttributeIndex ((short)value), &name);
								head.Append (name);
								head.Append ("\"");
								WriteStr (head, WithNewLine);
								break;
